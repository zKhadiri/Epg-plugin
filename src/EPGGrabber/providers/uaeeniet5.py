...
def main():
    ...
    try:
        ...
        response = requests.get('https://www.open-epg.com/files/uaepremium3.xml', verify=False, timeout=30)
        if response.status_code == 200:
            ...
            print("Failed to download /uaepremium3.xml. Status code: {}".format(response.status_code))
