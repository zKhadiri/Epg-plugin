...
# Paths
input_path = os.path.join(EPG_ROOT, 'uae6.xml')
...
def main():
    ...
    print("=============================================")
    print("Downloading UAE6_iet5 EPG guide...\nPlease wait...")
    sys.stdout.flush()
    try:
        # Download the XML file
        response = requests.get('https://www.open-epg.com/files/uae6.xml', verify=False, timeout=30)
        if response.status_code == 200:
            ...
            print("============================================")
            print("uae6.xml Downloaded Successfully")
            ...
            print("Failed to download /uae6.xml. Status code: {}".format(response.status_code))
            sys.exit(1)  # Exit if download fails
    except requests.exceptions.RequestException as e:  # Corrected exception syntax
        print("Failed to download /uae6.xml: {}".format(e))
