...
def main():
    print("*****************Sport_iet5_AR EPG******************")
    sys.stdout.flush()
    print("Downloading Sport_iet5_AR EPG guide\nPlease wait....")
    sys.stdout.flush()
    try:
        # Download the XML file
        response = requests.get('https://www.bevy.be/bevyfiles/qatar2.xml', verify=False)
...
def rename_file():
    ...
    print("you can modify the Sportiet5.py file at the following path:")
