...
# Paths
path = os.path.join(EPG_ROOT, 'arabia.xml')
...
def main():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # Change arabia.xml format to elcinema format
            ...
            print("Failed to download /arabia.xml. Status code: {}".format(response.status_code))
    except requests.exceptions.RequestException as e:
        print("Failed to download /arabia.xml: {}".format(e))
...
def rename_file():
    ...
    print("Cool .... congratulations your arabia.xml file is created - successfully done")
    print("############################################################")
