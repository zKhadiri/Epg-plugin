...
def main():
    ...
    try:
        ...
        response = requests.get('https://www.open-epg.com/files/saudiarabia1.xml', verify=False)
...
def rename_file():
    ...
    print("saudiarabia1.xml file successfully created")
    print("############################################################")
    print("The time is set to +0200 ,and if your time is different,")
    print("you can modify the saudiarabia1iet5.py file at the following path:")
...
def update_providers():
    with open(PROVIDERS_ROOT, 'r') as f:
        ...
        for channel in data['bouquets']:
            if channel["bouquet"] == "saudiarabia1iet5":
