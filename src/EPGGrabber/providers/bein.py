...
def bein():
    for i in range(0, 3):
        ...
        with requests.Session() as s:
            url = 'https://www.bein.com/en/epg-ajax-template/?action=epg_fetch&offset=%2B2&category=sports&serviceidentity=bein.net&mins=00&cdate={}&language=EN&postid=25356&loadindex=1'.format(str(week)) + str(i)
            link = s.get(url)
