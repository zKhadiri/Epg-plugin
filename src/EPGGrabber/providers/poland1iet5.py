...
# Paths
input_path = os.path.join(EPG_ROOT, 'poland1.xml')
...
def main():
    ...
    try:
        ...
        response = requests.get('https://www.open-epg.com/files/poland1.xml', verify=False, timeout=30)
        ...
        print("Failed to download /poland1.xml: {}".format(e))
...
def update_providers():
    with open(PROVIDERS_ROOT, 'r') as f:
        ...
        for channel in data['bouquets']:
            if channel["bouquet"] == "poland1iet5":
