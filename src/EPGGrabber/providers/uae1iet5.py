...
# Paths
input_path = os.path.join(EPG_ROOT, 'uaepremium1.xml')
...
def main():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print("##########################################")
            print("uaepremium1.xml Downloaded Successfully")
            print("##########################################")
            ...
            print("Failed to download /uaepremium1.xml. Status code: {}".format(response.status_code))
    except requests.exceptions.RequestException as e:
        print("Failed to download /uaepremium1.xml: {}".format(e))
...
def rename_file():
    ...
    print("uaepremium1.xml file is created - successfully done")
    print("############################################################")
