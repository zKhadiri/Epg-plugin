...
# Paths
input_path = os.path.join(EPG_ROOT, 'egypt1.xml')
...
def main():
    # Added code snippet
    print("**************Egypt1_iet5_EPG******************")
    sys.stdout.flush()  # Flush after the initial print
    sleep(1)  # Add a 1-second delay
    print("=============================================")

    print("Downloading Egypt1_iet5 EPG guide...\nPlease wait...")
    sys.stdout.flush()
    try:
        # Download the XML file
        response = requests.get('https://www.open-epg.com/files/egypt1.xml', verify=False)
        if response.status_code == 200:
            ...
            print("============================================")
            print("Egypt1.xml Downloaded Successfully")
            ...
            print("Failed to download /Egypt1.xml. Status code: {}".format(response.status_code))
            sys.exit(1)  # Exit if download fails
    except requests.exceptions.RequestException as e:  # Corrected exception syntax
        print("Failed to download /egypt1.xml: {}".format(e))
