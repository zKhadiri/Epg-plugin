...
# Paths
input_path = os.path.join(EPG_ROOT, 'uaepremium2.xml')
...
def main():
    ...
    try:
        ...
        response = requests.get('https://www.open-epg.com/files/uaepremium2.xml', verify=False)
...
def rename_file():
    ...
    print("you can modify the uaeariet5.py file at the following path:")
