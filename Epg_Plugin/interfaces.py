...
###### End 
    def __init__(self, session, args = 0):
        ...
        list.append(("Aljazeera.net ar EPG", "11","aljazeera"))
        list.append(("SKY IT EPG", "12","skyit"))
        list.append(("FREESAT UK", "13","freesat"))
        list.append(("UK SPORTS CHANNELS", "14","skyuk"))
        list.append(("DSTV.ZA", "15","dstv"))
        list.append(("SuperSport.ZA BACKUP", "16","dstvback"))
        list.append(("SETANTA eurasia", "17","setanta"))
        list.append(("INDIAN SPORTS CHANNELS EPG", "18","sony"))
