...
print("#########################################################"+'\n')
print("BEIN SPORTS :"+'\n')
print(' , '.join(chann).replace('_',' ')+'\n')
print("###########################################################"+'\n')
print("OSN :"+'\n')
print(' , '.join(xm).replace('_',' ')+'\n')
print("###########################################################"+'\n')
print("Bein entertainment :"+'\n')
print(' , '.join(net).replace('_',' ')+'\n')
print("###########################################################"+'\n')
print "SNRT :"+'\n'
print 'ALOULA , 2M , ARRIADIA , ATHAQAFIA , MEDI1TV'
print("###########################################################"+'\n')
print("EL CINEMA CHANNELS :"+'\n')
print(' , '.join(elc_channels).replace('_',' ')+'\n')
print("")
print ""
