...
for i in range(0,3):
    ...
    urls.append('http://epg.beinsports.com/utctime_ar.php?cdate='+str(week)+'&serviceidentity=beinsports.com&category=sports')
...
if __name__=='__main__':
    threads = [threading.Thread(target=bein, args=(url,)) for url in urls]
